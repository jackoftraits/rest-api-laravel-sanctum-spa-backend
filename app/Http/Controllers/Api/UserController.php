...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Block or cath any validation failure if there are any
        if ($validator->fails()) {
        ...
        // Add hash passsword to the request data
    ...
    public function update(Request $request, User $user)
    {
        ...
        /* If not empty, add to the request data - Start */
        ...
        /* If not empty, add to the request data - end */
